...
export default function AboutPage() {
    return (
        <main className="bg-background text-white min-h-screen w-full">
            <PageHeader
                title="About"
                subtitle="Heron Robotics · FTC 27621"
            />
            ...
            <section className="container mx-auto px-6 mt-12 md:mt-16">
                ...
                <motion.p className="mt-4 max-w-3xl text-white/90" {...fadeUp(0.2)}>
                    Heron Robotics is a student-run team based in Palo Alto. We encompass all aspects of FIRST, from high-level
                    robot design and efficient software to reaching out and impacting our local community. We have experienced members in FIRST
                    and are heading into our second year of competition in FTC.
                </motion.p>
            </section>
            ...
            <section className="container mx-auto px-6 mt-12 md:mt-16">
                ...
                >
                    ...
                    <ValueCard
                        ...
                        community wellness and interested in STEAM."
                    />
                    <ValueCard
                        title="Leadership"
            ...
            <section className="container mx-auto px-6 mt-12 md:mt-16">
                ...
                <motion.ul
                    className="mt-4 space-y-3 text-white/90 list-disc list-inside"
                    {...fadeUp(0.2)}
                >
                    <li>100+ kids impacted</li>
                    <li>3 partnered organizations</li>
                    <li>5 camps hosted</li>
                    <li>Currently working on a region-wide project</li>
                </motion.ul>
            </section>
